...
namespace V2_API_CSHARP.controllers
{
    ...
    public class smsController : Controller
    {
        ...
        [HttpPost]
        [Route("Send")]
        public IActionResult Send(string action_cmd, string apikey, string c, string dest, string texto, string sand, string nombre)
        {
            if (action_cmd == "send")
        ...
        [HttpPost]
        [Route("Credits")]
        public IActionResult Credits(string action_cmd,string apikey)
        {
        ...
        [HttpPost]
        [Route("Register")]
        public IActionResult Register(string action_cmd, string apikey, string nombre, string c, string dest, string digitos, string formato)
        {
        ...
        [HttpPost]
        [Route("Validate")]
        public IActionResult Validate(string action_cmd, string apikey, string code, string dest, string formato)
        {
